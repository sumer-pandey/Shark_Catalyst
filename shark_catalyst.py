...
st.set_page_config(page_title="Venture Catalyst - Interactive Analytics Platform for Indian Startup Ecosystem", page_icon="assets/logo.png", layout="wide")
...
def render_header():
    ...
    if os.path.exists(logo_path):
        ...
        with mid:
            st.image(logo_path, width=80, use_container_width=False, caption=None)

    col1, col2 = st.columns([4,1])
    with col1:
        st.markdown("<h1 style='margin:0;padding:0'>Venture Catalyst - Interactive Analytics Platform for Indian Startup Ecosystem</h1>", unsafe_allow_html=True)
